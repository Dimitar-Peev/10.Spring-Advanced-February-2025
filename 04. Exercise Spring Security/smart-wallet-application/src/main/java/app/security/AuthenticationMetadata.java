...
public class AuthenticationMetadata implements UserDetails {
    ...
    public Collection<? extends GrantedAuthority> getAuthorities() {
        ...
        SimpleGrantedAuthority authority = new SimpleGrantedAuthority("ROLE_" + role.name()); // hasRole ROLE_ADMIN
//        SimpleGrantedAuthority authority = new SimpleGrantedAuthority(role.name()); // hasAuthority ADMIN
